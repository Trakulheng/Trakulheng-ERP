...
function CustomerPanel({
  ...
  return (
    <div className="fixed inset-0 h-screen bg-black/40 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-4">
...
function NewRedemptionModal({
  ...
  return (
    <div className="fixed inset-0 h-screen bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
